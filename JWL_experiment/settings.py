...
SESSION_CONFIG_DEFAULTS = dict(
    real_world_currency_per_point=2.00, participation_fee=5000.00, doc=""
)
...
SESSION_CONFIGS = [
    dict(
        name = 'exp1',
        app_sequence = ['codenhi','hi', 'cynical_practice', 'cynical_again', 'aftermath', 'payment_thanku'],
        num_demo_participants = 80
    ),
    dict(
        name = 'exp2',
        app_sequence = ['codenhi','instruction_2', 'cynical_practice', 'cynical_again', 'aftermath', 'payment_thanku'],
        num_demo_participants = 80
    ),
    dict(
        name = 'exp3',
        app_sequence = ['codenhi_stage','staghuntgame_practice', 'staghuntgame', 'instruction_2', 'cynical_practice', 'cynical_again', 'aftermath', 'payment_thanku'],
        num_demo_participants = 80
    ),
    dict(
        name = 'stag',
        app_sequence = ['staghuntgame_practice','staghuntgame'],
        num_demo_participants = 1
    ),
    dict (
        name = 'aftermath',
        app_sequence = ['aftermath'],
...
SECRET_KEY = '7q7l!^0d=m+9q&^rsqt#iw@$uq3jlok4nab2jb-w#t+_7u#l*d'
